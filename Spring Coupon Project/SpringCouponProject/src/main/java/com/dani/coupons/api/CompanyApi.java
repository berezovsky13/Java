...
public class CompanyApi {
	...
	@PutMapping
	public void updateCompany(HttpServletRequest req,@RequestBody CompanyEntity company) throws ApplicationException {
	...
	@GetMapping("/{id}")
	public CompanyEntity getCompanyById (@PathVariable long id) throws ApplicationException {
	...
	@GetMapping
	public Collection<CompanyEntity> getAllCompanies(HttpServletRequest req) throws ApplicationException {
